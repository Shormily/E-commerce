            ...
            <div className="testimonials bgc2 text-dark ">
              <div className="container">
                <div className="row offset-1">
                  <div className="col-lg-5 col-md-5 testimonials p-5">
                    <p className="text-dark">
                      Et erat eirmod gubergren ut consetetur est lorem lorem
                      lorem sea, ea sanctus voluptua amet est labore ipsum sed
                      takimata..
                    </p>
                  ...
                  <div className="col-lg-5 col-md-5 testimonials p-5">
                    ...
                    <img src={user2} className="text-dark " alt="" />
                    <p className="user-details text-dark">
                      <b>Johan Doe</b>
                      <br />
                      Director at xyz
              ...
              <div className="container">
                <div className="row offset-1">
                  <div className="col-lg-5 col-md-5 testimonials p-5">
                    ...
                    <img src={so1} className="text-dark " alt="" />
                    <p className="user-details text-dark">
                      <b>Agelina</b>
                      <br />
                      Co-founder at xyz
                  ...
                  <div className="col-lg-5 col-md-5 testimonials p-5">
                    ...
                    <img src={so2} className="text-dark " alt="" />
                    <p className="user-details text-dark">
                      <b>Johan Doe</b>
                      <br />
                      Director at xyz
              ...
              <div className="container">
                <div className="row offset-1">
                  <div className="col-lg-5 col-md-5 testimonials p-5">
                    ...
                    <img src={so3} className="text-dark " alt="" />
                    <p className="user-details text-dark">
                      <b>Agelina</b>
                      <br />
                      Co-founder at xyz
      ...
      <div className="social-media">
        <div className="container text-center">
          ...
          <div className="social-icon">
            <a href="#">
              {" "}
              <img src={facebookicon} className=" decoeations" alt="" />
            </a>
            <a href="#">
              {" "}
              <img src={snapchaticon} className="decoeations " alt="" />
            </a>
            <a href="#">
              {" "}
              <img src={twittericon} className=" decoeations" alt="" />
            </a>
            <a href="#">
              {" "}
              <img src={whatsappicon} className=" decoeations" alt="" />
            </a>
            <a href="#">
              {" "}
              <img src={linkedinicon} className=" decoeations" alt="" />
            </a>
            <a href="#">
              {" "}
              <img src={instagramicon} className=" decoeations" alt="" />
            </a>
          </div>
        </div>
      </div>
